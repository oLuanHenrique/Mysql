...
<html>
 ...
 <body style="background-color: rgb(146, 202, 49);">
    <nav style="background-color: rgb(23, 49, 9);">
        <center><b style="font-size: 40px ;color: white;"> Produtos </b> </center>
    </nav>
    <div>
       ...
       <div class = "row">
          <div class = "col s2"></div>
           <div class="col s8" style="background-color: rgb(244, 251, 234);">
            <center> <h5><b>Cadastre um novo produto</b></h5></center><br>
           <form action="Cadastro_cliente.php" method="post">
           <b>Nome:</b><input type="text" name="nome" >
           <b>Descrição:</b> <input type="text" name="desccricao">
           <b>Preço:</b> <input type="text" name="preco">
           <b>Data atualizado:</b> <input type="text" name="data_atualizado">
